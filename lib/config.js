...
Router.route('/blog_detail_not_logged_in/:blog_id', 
function () {
     var  params = this.params; 
  this.render('blog_detail_not_logged_in');
},{
    onAfterAction: function() {
      return setTitle('Blog details not logged-in');
    }
  },
);

Router.route('/admin_blog_detail/:blog_id', 
function () {
     var  params = this.params; 
  this.render('admin_blog_detail');
},{
    onAfterAction: function() {
      return setTitle('Admin Blog details');
    }
  },
);
...
Router.route('/edit_about_us', function () {
  this.render('edit_about_us');
},{
    onAfterAction: function() {
...
Router.route('/community/followers', function () {
  var  params = this.params; // { _id: "5" }
  var userId = params.id; // "5"
  this.render('followers');
},{
    onAfterAction: function() {
      return setTitle('followers Detail');
    }
  });

Router.route('/community/following', function () {
  var  params = this.params; // { _id: "5" }
  var userId = params.id; // "5"
  this.render('following');
},{
    onAfterAction: function() {
      return setTitle('following Detail');
    }
  });
...
Router.route('/preview', function () {
  this.render('preview');
    ...
    onAfterAction: function() {
      return setTitle('preview');
    }
  });

Router.route('/testimonial', function () {
  this.render('testimonial');
},{
    onAfterAction: function() {
      return setTitle('testimonial');
    }
  });
...
Router.route('/admin_notification', function () {
  this.render('admin_notification');
},{
    onAfterAction: function() {
      return setTitle('Admin Notification');
    }
  });
...
Router.route('/client_notification', function () {
  this.render('client_notification');
},{
    onAfterAction: function() {
      return setTitle('Client Notification');
    }
  });
...
Router.route('/review_request_listing_individual/:request_id', function () {
  var  params = this.params; // { _id: "5" }
  var userId = params.id; // "5"
  this.render('review_request_listing_individual');
},{
    onAfterAction: function() {
      return setTitle('Campaign Detail');
    }
...
Router.route('/review_approval_listing_individual/:request_id', function () {
  var  params = this.params; // { _id: "5" }
  var userId = params.id; // "5"
  this.render('review_approval_listing_individual');
},{
    onAfterAction: function() {
      return setTitle('Campaign Review Approval listing');
    }
  });
...
Router.route('/campaign_completion_report/:campaign_id', function () {
  var  params = this.params; 
  var userId = params.id; 
  this.render('campaign_completion_report');
},{
    onAfterAction: function() {
      return setTitle('Campaign Completion Report');
    }
  });

Router.route('/newsignin', function () {
  this.render('newsignin');
},{
    onAfterAction: function() {
      return setTitle('New Sign in');
    }
  });