...
Template.display_blog_detail_not_logged_in.onDestroyed(function () {
  book_listing.stop();
...
Template.display_blog_detail_not_logged_in.onCreated(function eventlistOnCreated(){
...
{
  Router.go("/blog_detail/"+url);
}

});

Template.display_blog_detail_not_logged_in.onRendered(function () {
  ...
  book_listing = Meteor.subscribe("fetch_blog_content_with_blog_id",blog_id);
 ...
 Template.display_blog_detail_not_logged_in.helpers({
...
Template.display_blog_detail_not_logged_in.events({
