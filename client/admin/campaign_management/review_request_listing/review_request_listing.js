...
Template.show_review_request_listing.onDestroyed(function () {
  book_listing.stop();
  request_listing.stop();
  user_details_listing.stop();
});

Template.show_review_request_listing.onCreated(function eventlistOnCreated(){
...
Template.show_review_request_listing.onRendered(function () {
 ...
 Template.show_review_request_listing.helpers({
    ...
    show_campaign_listing(){
      ...
      var result = review_details.find({content_type: "review_request",approval_status: 0}).fetch();
      return result;
    },
...
Template.show_review_request_listing.events({
