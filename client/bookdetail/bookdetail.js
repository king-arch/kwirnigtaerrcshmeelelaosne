...
Template.bookdetailpage.onDestroyed(function () {
  book_listing.stop();
});

Template.bookdetailpage.onCreated(function eventlistOnCreated(){

});

Template.bookdetailpage.onRendered(function () {
 ...
 Template.bookdetailpage.helpers({
    ...
    show_book_detail(){
      ...
      var book_id = Session.set("get_book_id",book_id);
...
Template.bookdetailpage.events({
