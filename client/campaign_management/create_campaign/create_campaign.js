...
$(".show_packages").addClass("loader_visiblity_block");
 ...
 Template.create_campaign_detail.helpers({
    ...
    import_catagries(){
      ...
      Meteor.subscribe("campaign_details");
...
console.log("just above");
      ...
      Meteor.call('save_campaign_details',select_package,book_name,book_summary,author_name,author_description,amazon_link,delivery_option,additional_information,book_price,book_catagries,book_cover,final_payment,function (error, result) {
      if (error) {
